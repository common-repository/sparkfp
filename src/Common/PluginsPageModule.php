...
class PluginsPageModule implements ModuleInterface
{
    ...
    public function addPluginPageActionLinks($links)
    {
        ...
        $settingsLink = '<a href="' . $settingsUrl . '">' . __('Settings', 'sparkfp') . '</a>';
        $upgradeProLink = '<a target="_blank" href="' . $this->pluginMeta->websiteUrl . '">' . __('Upgrade PRO', 'sparkfp') . '</a>';
    ...
    public function addPluginPageRowLinks($links, $file)
    {
        ...
        $supportLink = '<a target="_blank" href="https://www.sparkplugins.com/support/">' . __('Support', 'sparkfp') . '</a>';
        $prependLinks = array();
