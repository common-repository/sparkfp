...
namespace Sparkfp\SparkPlugins\SparkWoo\ProductRecommendationsFree\Analytics;

use Sparkfp\SparkPlugins\SparkWoo\Common\Database\Database;
use Sparkfp\SparkPlugins\SparkWoo\Common\Database\OrderItem;
use Sparkfp\SparkPlugins\SparkWoo\Common\Loader;
use Sparkfp\SparkPlugins\SparkWoo\Common\Modules\ModuleInterface;
use Sparkfp\SparkPlugins\SparkWoo\Common\Notifications\DismissNotificationTrait;
use Sparkfp\SparkPlugins\SparkWoo\Common\Notifications\NotificationModule;
use Sparkfp\SparkPlugins\SparkWoo\Common\Options\StringOption;
use Sparkfp\SparkPlugins\SparkWoo\Common\Plugins\PluginMeta;
use Sparkfp\SparkPlugins\SparkWoo\ProductRecommendations\Analytics\AnalyticsEvent;
use Sparkfp\SparkPlugins\SparkWoo\ProductRecommendations\Analytics\AnalyticsEventRepository;
