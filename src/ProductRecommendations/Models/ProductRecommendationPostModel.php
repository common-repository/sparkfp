...
namespace Sparkfp\SparkPlugins\SparkWoo\ProductRecommendations\Models;

use Sparkfp\SparkPlugins\SparkWoo\Common\Collections\CollectionInterface;
use Sparkfp\SparkPlugins\SparkWoo\Common\Models\AbstractPostModel;
...
class ProductRecommendationPostModel extends AbstractPostModel implements PostModelInterface
{
    ...
    {
        $labels = array('name' => __('Product recommendations', 'sparkfp'), 'singular_name' => __('Product recommendation', 'sparkfp'), 'menu_name' => __('Product recommendations', 'sparkfp'), 'all_items' => __('All product recommendations', 'sparkfp'), 'view_item' => __('View product recommendation', 'sparkfp'), 'add_new_item' => __('Add product recommendation', 'sparkfp'), 'add_new' => __('Add product recommendation', 'sparkfp'), 'edit_item' => __('Edit product recommendation', 'sparkfp'), 'update_item' => __('Update product recommendation', 'sparkfp'), 'search_items' => __('Search product recommendations', 'sparkfp'), 'not_found' => __('Not found', 'sparkfp'), 'not_found_in_trash' => __('Not found in bin', 'sparkfp'));
        $args = array('label' => __('Product recommendations', 'sparkfp'), 'description' => __('Product recommendations', 'sparkfp'), 'rewrite' => array('slug' => 'product_recommendations'), 'labels' => $labels, 'supports' => array('title', 'custom-fields'), 'hierarchical' => \false, 'public' => \false, 'show_ui' => SPARK_DEV_MODE, 'show_in_menu' => \true, 'show_in_nav_menus' => \false, 'show_in_admin_bar' => \false, 'menu_position' => 5, 'can_export' => \false, 'has_archive' => \false, 'exclude_from_search' => \false, 'publicly_queryable' => \false, 'query_var' => \false, 'capability_type' => 'post', 'show_in_rest' => \false);
        return $args;
    }
