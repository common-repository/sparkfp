...
namespace Sparkfp\MathPHP\Statistics\Regression\Methods;

use Sparkfp\MathPHP\Exception\BadDataException;
use Sparkfp\MathPHP\Exception\BadParameterException;
use Sparkfp\MathPHP\Exception\IncorrectTypeException;
use Sparkfp\MathPHP\LinearAlgebra\MatrixFactory;
use Sparkfp\MathPHP\Statistics\RandomVariable;
use Sparkfp\MathPHP\Functions\Map\Single;
use Sparkfp\MathPHP\Functions\Map\Multi;
use Sparkfp\MathPHP\Probability\Distribution\Continuous\F;
use Sparkfp\MathPHP\Probability\Distribution\Continuous\StudentT;
use Sparkfp\MathPHP\LinearAlgebra\NumericMatrix;
use Sparkfp\MathPHP\Exception;
trait LeastSquares
{
    /**
     * Regression ys
