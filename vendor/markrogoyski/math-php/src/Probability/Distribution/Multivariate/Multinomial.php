...
namespace Sparkfp\MathPHP\Probability\Distribution\Multivariate;

use Sparkfp\MathPHP\Probability\Combinatorics;
...
class Multinomial
{
    ...
    public function pmf(array $frequencies) : float
    {
        ...
        $x₁！⋯xk！ = \array_product(\array_map('Sparkfp\\MathPHP\\Probability\\Combinatorics::factorial', $frequencies));
