 ...
 */
namespace Sparkfp\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'Sparkfp\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'Sparkfp\\Mes\\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'Sparkfp\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'Sparkfp\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'Sparkfp\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'Sparkfp\\Mon\\1'],
        // Default rule
        ['/s$/i', ''],
    ];
